...
#make Plot 3
plot(power_con$Sub_metering_1 ~ power_con$DateTime, type="l", ylab="Energy sub metering", xlab="")
lines(power_con$Sub_metering_2~ power_con$DateTime, col="Red")
lines(power_con$Sub_metering_3~ power_con$DateTime, col="Blue")
